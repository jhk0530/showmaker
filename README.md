...
[![Windows](https://custom-icon-badges.demolab.com/badge/-Windows-0078D6?style=for-the-badge&logo=windows11)](https://github.com/jhk0530/showmaker/releases/download/v0.2.3/showmaker_0.2.3_x64_en-US.msi)
[![MacOS](https://img.shields.io/badge/-MacOS-0078D6?style=for-the-badge&logo=apple)](https://github.com/jhk0530/showmaker/releases/download/v0.2.3/showmaker_0.2.3_aarch64.dmg)
...
1. Prepare a markdown file – Create or obtain a sample `.md` file.
   ...
   You can use `revealjs` for **HTML**, `pptx` for **Powerpoint**, `beamer` for **PDF**.
...
<p align="center">
  <img width="500" alt="1" src="docs/images/1.png" />  
</p>

3. Render and Download slide with `showmaker` – Use the `Render` button

<p align="center">
  <img width="500" alt="2" src="docs/images/2.png" />
</p>

4. Use your presentation – Open the generated Quarto-based slides.
